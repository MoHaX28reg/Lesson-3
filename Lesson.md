...
Для того, чтобы создать ветку, используется команда *git branch*. Делается это следующим образом в папке с репозиторием: *git branch <название новой ветки>*. Для создания и немедленного перехода в новую ветку нужно прописать команду *git checkout -b <название ветки>*. Посколедняя команда ускоряет процесс.
